...
void InitDrawText()
{
    ...
    if( !textProgram )
    {
        ...
        glAttachShader( textProgram, LoadShader( GL_VERTEX_SHADER, "vertex/text_vs.glsl" ) );
        glAttachShader( textProgram, LoadShader( GL_FRAGMENT_SHADER, "fragment/text_fs.glsl" ) );
