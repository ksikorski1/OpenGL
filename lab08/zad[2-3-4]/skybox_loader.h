...
void CreateSkyBox(char* vertex, char* fragment)
{
	...
	glAttachShader( SkyBox_Program, LoadShader(GL_VERTEX_SHADER, vertex));
	glAttachShader( SkyBox_Program, LoadShader(GL_FRAGMENT_SHADER, fragment));
