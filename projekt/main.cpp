...
void Keyboard( unsigned char key, int x, int y )
{
    ...
    std::vector<OpenGLObjectInstanced> lista_obiektow = {Tree, kwiatki};
    //lista_obiektow.push_back(Tree);
    //lista_obiektow.push_back(kwiatki);
    // 0 - obiekt przez ktory nie da sie przejsc
    // 1 - obiekt dajacy punkty, ktory powinien zniknac przy kolizji
...
int main( int argc, char *argv[] )
{
    ...
    glutCreateWindow( "Jakub Sikorski - projekt" );
